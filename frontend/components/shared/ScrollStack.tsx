...
const ScrollStack = ({
  ...
  const scrollerClassName = `scroll-stack-scroller ${useWindowScroll ? 'window-scroll' : ''} ${className}`.trim();
  const innerClassName = `scroll-stack-inner ${useWindowScroll ? 'window-scroll' : ''}`.trim();
